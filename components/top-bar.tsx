    ...
    <div className="border-b border-border bg-canvas">
      <div className="mx-auto flex max-w-[1040px] items-center gap-3 px-6 py-3">
        ...
        <div className="ml-auto flex items-center gap-3">
          <span
            className="hidden items-center gap-1.5 rounded-full bg-surface px-2.5 py-1 font-mono text-[11px] text-muted sm:flex"
          ...
          <Link
            href="/"
            className="rounded-md border border-border px-2.5 py-1.5 text-[12.5px] font-medium text-ink-soft outline-none transition hover:bg-surface-2 focus-visible:ring-2 focus-visible:ring-accent/25"
          >
            ← Back to case study
          </Link>
        </div>
