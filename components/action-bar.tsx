  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <button
          onClick={onUndo}
          className="rounded-md border border-border px-3 py-1.5 text-[12.5px] font-medium text-ink-soft transition hover:bg-surface-2"
        >
          Undo
        </button>
        <button
          onClick={onAccept}
          className="flex items-center gap-1.5 rounded-md bg-good px-3.5 py-1.5 text-[12.5px] font-medium text-white transition hover:brightness-105"
        >
